...
namespace synchronizer {
    ...
    struct has_get_data {
        template<typename U>
        static std::true_type f(decltype(&U::get_data));
    ...
    struct has_get_time {
        template<typename U>
        static std::true_type f(decltype(&U::get_time));
    ...
    struct has_next {
        template<typename U>
        static std::true_type f(decltype(&U::next));
    ...
    struct has_has_next {
        template<typename U>
        static std::true_type f(decltype(&U::has_next));
