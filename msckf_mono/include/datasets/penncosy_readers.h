...
namespace penncosy_dataset {
    ...
    public:
        ...
        //          |- sub_sensor_name
        //             |- images
        Sensor(std::string folder, std::string sensor_name, std::string seq, std::string csv_name,
    ...
    protected:
        ...
        void read_config(Lambda config_reader_func, std::string yaml_name) {
            std::string config_name(folder_ + std::string("/data/") + sensor_name_ + std::string("/") + yaml_name);
            cv::FileStorage fs2;
    ...
    public:
        VICamera(std::string folder, std::string sensor_name, std::string seq, std::string csv_name,
                 std::string sub_sensor_name = "");
